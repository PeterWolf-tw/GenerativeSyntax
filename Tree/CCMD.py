...
CCMDPatDICT = {"ACTION_verb":[re.compile("<ACTION_verb>[^<]+</ACTION_verb>(.+<FUNC_inner>的</FUNC_inner>(<MODIFIER>[^<]+</MODIFIER>)?)?(<ENTITY_noun>[^<]+?</ENTITY_noun>|<ENTITY_pronoun>[^<]+?</ENTITY_pronoun>|<ENTITY_person>[^<]+?</ENTITY_person>)")],
               ...
               "ENTITY_noun":[re.compile("(.+<FUNC_inner>的</FUNC_inner>)?<ENTITY_noun>[^<]+</ENTITY_noun>(<VerbP>[^<]+?</VerbP>|<ACTION_verb>[^<]+?</ACTION_verb>)((?<!的<FUNC_inner>)<ENTITY_noun>[^<]+?</ENTITY_noun>|<ENTITY_pronoun>[^<]+?</ENTITY_pronoun>|<ENTITY_person>[^<]+?</ENTITY_person>)((<VerbP>[^<]+?</VerbP>|<ACTION_verb>[^<]+?</ACTION_verb>|<FUNC_inner>的</FUNC_inner>)(<ENTITY_noun>[^<]+?</ENTITY_noun>|<ENTITY_pronoun>[^<]+?</ENTITY_pronoun>|<ENTITY_person>[^<]+?</ENTITY_person>))?"),
                              re.compile("<ENTITY_noun>[^<]+</ENTITY_noun><FUNC_inner>的</FUNC_inner>(<ENTITY_noun>[^<]+?</ENTITY_noun>|<ENTITY_pronoun>[^<]+?</ENTITY_pronoun>|<ENTITY_person>[^<]+?</ENTITY_person>)"),
                              ],
...
def CCMDchecker(inputSTR, argX, argY):
    ...
    if argXPOS in CCMDPatDICT.keys():
        for xPat in range(0, len(CCMDPatDICT[argXPOS])):
            checkingTagLIST =[p.group(0) for p in  CCMDPatDICT[argXPOS][xPat].finditer(inputTagSTR)]
